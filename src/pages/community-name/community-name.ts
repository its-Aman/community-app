...
export class CommunityNamePage {
  ...
  performance() {
    let performance = this.modal.create('PerformanceModalPage', { data: this.personData, id: this.eventData.event.id, event_entry_id: this.eventData.event_entry_id }, { cssClass: 'performance' });
    performance.present();
